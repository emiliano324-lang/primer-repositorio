...
public class Tanque extends Personaje{
	...
	public Tanque(String nombre, int vidaMaxima, int vidaActual, int poderAtaque, Arma arma, int nivel, int experiencia,
	...
	public void habilidad(Personaje objetivo) {
		...
		objetivo.setTipoEfecto("DESESPERANZA");
		objetivo.setTieneEfecto(true);
		objetivo.setDuracionEfecto(4);
		System.out.println("Se ha aplicado DESESPERANZA por 4 turnos");
	}
