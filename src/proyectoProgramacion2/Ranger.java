...
public class Ranger extends Personaje{
	...
	public Ranger(String nombre, int vidaMaxima, int vidaActual, int poderAtaque, Arma arma, int nivel, int experiencia,
	...
	public void habilidad(Personaje objetivo) {
		...
		objetivo.setTipoEfecto("TIROALACABEZA");
		objetivo.setTieneEfecto(true);
		objetivo.setDuracionEfecto(3);
		System.out.println("Se ha aplicado TIRO A LA CABEZA por 3 turnos");
